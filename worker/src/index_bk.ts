  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  function exportLinks() {
	...
	var rows = links.map(function(l) {
	  ...
	  var copyBtn = '<button onclick="copyUrl(this)" data-url="' + safeUrl + '" style="font-size:11px;padding:2px 8px;border:1px solid #d2d2d7;border-radius:4px;background:white;cursor:pointer;color:#6e6e73;margin-left:8px;vertical-align:middle;">Copy URL</button>';
	...
	var html = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
	  ...
	  + '</style>'
	  + '<script>function copyUrl(b){navigator.clipboard.writeText(b.dataset.url).then(function(){var t=b.textContent;b.textContent="Copied!";setTimeout(function(){b.textContent=t;},1500);});}<\/script>'
